...
// @WebMvcTest(HoneywellController.class)
// class HoneywellControllerMockMvcTest {
...
//     @Test
//     @DisplayName("GET /honeywell/realtimeDistrictWiseCallReport - success")
//     void getRealtimeDistrictWiseCallReport_Success() throws Exception {
//         String expectedResponse = "{\"data\":\"realtime_report_data\"}";
//         when(honeywellService.getRealtimeDistrictWiseCallReport()).thenReturn(expectedResponse);

//         mockMvc.perform(get("/honeywell/realtimeDistrictWiseCallReport"))
//                 .andExpect(status().isOk())
//                 .andExpect(jsonPath("$.statusCode").value(200))
//                 .andExpect(jsonPath("$.status").value("Success"))
//                 .andExpect(jsonPath("$.errorMessage").value("Success"))
//                 .andExpect(jsonPath("$.data.data").value("realtime_report_data"));
//     }

//     @Test
//     @DisplayName("GET /honeywell/realtimeDistrictWiseCallReport - exception")
//     void getRealtimeDistrictWiseCallReport_Exception() throws Exception {
//         when(honeywellService.getRealtimeDistrictWiseCallReport()).thenThrow(new RuntimeException("Service unavailable"));

//         mockMvc.perform(get("/honeywell/realtimeDistrictWiseCallReport"))
//                 .andExpect(status().isOk())
//                 .andExpect(jsonPath("$.statusCode").value(500))
//                 .andExpect(jsonPath("$.status", containsString("Failed with Service unavailable at")))
//                 .andExpect(jsonPath("$.errorMessage").value("Service unavailable"));
//     }

//     @Test
//     @DisplayName("POST /honeywell/districtWiseCallReport - success")
//     void getDistrictWiseCallReport_Success() throws Exception {
//         String requestBody = "{\"district\":\"someDistrict\"}";
//         String serviceResponse = "{\"data\":\"district_report_data\"}";

//         when(honeywellService.getDistrictWiseCallReport(any())).thenReturn(serviceResponse);

//         mockMvc.perform(post("/honeywell/districtWiseCallReport")
...
//                 .andExpect(jsonPath("$.status").value("Success"))
//                 .andExpect(jsonPath("$.errorMessage").value("Success"))
//                 .andExpect(jsonPath("$.data.data").value("district_report_data"));
//     }

//     @Test
//     @DisplayName("POST /honeywell/districtWiseCallReport - exception")
//     void getDistrictWiseCallReport_Exception() throws Exception {
//         String requestBody = "{\"district\":\"someDistrict\"}";

//         when(honeywellService.getDistrictWiseCallReport(any())).thenThrow(new RuntimeException("District report failed"));
...
//                 .andExpect(status().isOk())
//                 .andExpect(jsonPath("$.statusCode").value(500))
//                 .andExpect(jsonPath("$.status", containsString("Failed with District report failed at")))
//                 .andExpect(jsonPath("$.errorMessage").value("District report failed"));
//     }

//     @Test
//     @DisplayName("POST /honeywell/urbanRuralCallReport - success")
//     void getUrbanRuralCallReport_Success() throws Exception {
//         String requestBody = "{\"type\":\"urban\"}";
//         String serviceResponse = "{\"data\":\"urban_rural_report_data\"}";

//         when(honeywellService.getUrbanRuralCallReport(any())).thenReturn(serviceResponse);

//         mockMvc.perform(post("/honeywell/urbanRuralCallReport")
//                         .contentType(MediaType.APPLICATION_JSON)
//                         .content(requestBody))
//                 .andExpect(status().isOk())
//                 .andExpect(jsonPath("$.statusCode").value(200))
//                 .andExpect(jsonPath("$.status").value("Success"))
//                 .andExpect(jsonPath("$.errorMessage").value("Success"))
//                 .andExpect(jsonPath("$.data.data").value("urban_rural_report_data"));
//     }

//     @Test
//     @DisplayName("POST /honeywell/urbanRuralCallReport - exception")
//     void getUrbanRuralCallReport_Exception() throws Exception {
//         String requestBody = "{\"type\":\"urban\"}";

//         when(honeywellService.getUrbanRuralCallReport(any())).thenThrow(new RuntimeException("Urban/rural report failed"));
...
//                 .andExpect(status().isOk())
//                 .andExpect(jsonPath("$.statusCode").value(500))
//                 .andExpect(jsonPath("$.status", containsString("Failed with Urban/rural report failed at")))
//                 .andExpect(jsonPath("$.errorMessage").value("Urban/rural report failed"));
//     }
// }
