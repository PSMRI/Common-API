...
public class VideoCallServiceImpl implements VideoCallService {
    ...
    private void saveRecordingFile(String meetingLink) {
        try {
            ...
            String jibriOutputDir = ConfigProperties.getPropertyByName("jibri.output.path"); // e.g.,
                                                                                             // /srv/jibri/recordings
            ...
            File[] matchingFiles = jibriDir
                    .listFiles((dir, name) -> name.contains(meetingLink) && name.endsWith(".mp4"));
