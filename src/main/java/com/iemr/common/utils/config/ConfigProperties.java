...
public class ConfigProperties
{
	...
	@Value("${iemr.session.expiry.time.changePassword:100}")
	private static Integer sessionExpiryTimeForChangePassword;
	
	@Value("${iemr.extend.expiry.time.changePassword:false}")
	private static Boolean extendExpiryTimeForChangePassword;
	...
	public static int getSessionExpiryTimeForChangePassword()
	{
		if (sessionExpiryTimeForChangePassword == null)
		{
			sessionExpiryTimeForChangePassword = getInteger("iemr.session.expiry.time.changePassword");
		}
		return sessionExpiryTimeForChangePassword;
	}
	
	public static boolean getExtendExpiryTimeForChangePassword()
	{
		if (extendExpiryTimeForChangePassword == null)
		{
			extendExpiryTimeForChangePassword = getBoolean("iemr.session.expiry.time.changePassword");
		}
		return extendExpiryTimeForChangePassword;
	}
